...
- Name: api.documents.spec.ts >> documents repository >> metadata edit + preview URL: PM can rename and previews resolve to a signed URL
- Location: tests/api.documents.spec.ts:59:3

...
- Name: api.documents.spec.ts >> documents repository >> upload validation: POST /documents rejects an invalid objectPath
- Location: tests/api.documents.spec.ts:97:3

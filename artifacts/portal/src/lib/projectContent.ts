export const ROLES = [
  { id: "pm_lead", label: "PM / Líder de Proyecto (C2Labs)", description: "Liderazgo general del piloto, planificación y coordinación con CEL. Puede ser asumido por más de una persona." },
